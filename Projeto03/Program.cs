...
namespace Projeto03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            fornecedor.Produto = new List<Produto>();

            //adicionando produtos na lista..
            fornecedor.Produto.Add(new Produto(Guid.NewGuid(), "Notebook", 2000, 10, new DateTime(2021, 07, 09)));
            fornecedor.Produto.Add(new Produto(Guid.NewGuid(), "Mochila", 500, 20, new DateTime(2021, 07, 10)));
            fornecedor.Produto.Add(new Produto(Guid.NewGuid(), "Celular", 1000, 15, new DateTime(2021, 07, 11)));
            ...
            try
            {
                ...
                {
                    //inicializando a interface com a classe FornecedorRepositoryJSON..
                    fornecedorRepository = new FornecedorRepositoryJSON(); //POLIMORFISMO
                }
                else if (tipo.Equals("TXT", StringComparison.OrdinalIgnoreCase))
                {
                    //inicializando a interface com a classe FornecedorRepositoryTXT
